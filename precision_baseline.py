...
for sub in tqdm(sub_list,position=0):
    ...
    np.save(os.path.join(RESULTS_DIR, str(sub)+'_hyperlayer_fast_baseline_weights.npy'), learned_ws, allow_pickle=True)
...
np.save(os.path.join(RESULTS_DIR, str(sub)+'_hyperlayer_fast_baseline_gammas.npy'), gammas, allow_pickle=True)
