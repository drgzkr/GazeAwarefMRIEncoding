...
Two precomputed `.pkl` files are required by `analysis.py` for Figures 3a–d. These were originally exported from custom scripts and are not regenerated by the encoding model scripts:
