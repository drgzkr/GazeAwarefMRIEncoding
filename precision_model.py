...
#can run this as a loop outside of the function for debugging
    ...
    np.save('/path/gaze_'+save_title+'_voxel_predicted_response_7_16',predicted_feat_model_brain,allow_pickle=True)
    np.save('/path/gaze_'+save_title+'_voxel_model_weights_7_16',encoder_model_brain_weights,allow_pickle=True)

    np.save('/path/gaze_'+save_title+'_all_voxels_nan_indices_7_16',all_voxels_all_nan_fixations,allow_pickle=True)
    np.save('/path/gaze_'+save_title+'_all_voxels_empty_trs_7_16',all_voxels_empty_trs,allow_pickle=True)

    np.save('/path/fgaze_'+save_title+'_encoding_output_summary_7_16',output_summary,allow_pickle=True)
    np.save('/path/gaze_'+save_title+'_average_feature_model_brain_7_16',average_feat_model_brain,allow_pickle=True)
